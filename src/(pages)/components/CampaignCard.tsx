      ...
      <Link href={`/campaign/${title}`}>
        <div className="bg-white shadow-md hover:shadow-lg rounded-md overflow-hidden">
          ...
          <div className="p-4">
            ...
            {/* <button
              onClick={handlesDonate}
              className="mt-4 px-4 py-2 bg-indigo-500 text-white rounded-md hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
              기부하기 */}
            {/* </button> */}
            <br></br>
